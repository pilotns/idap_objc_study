...
describe(@"AMPReference", ^{
    ...
    context(@"when create with +retainReferenceWithTarget:", ^{
        ...
        itBehavesLike(@"AMPReference class equality", @{@"object" : reference, @"class" : [AMPRetainReference class]});
        
        itBehavesLike(@"AMPReference target pointer equality", @{@"object" : reference, @"target" : target});
    });
    
    context(@"when create with +assignReferenceWithTarget:", ^{
        reference = [AMPReference assignReferenceWithTarget:target];
        
        itBehavesLike(@"AMPReference class equality", @{@"object" : reference, @"class" : [AMPAssignReference class]});
    ...
    context(@"when create with +copyReferenceWithTarget:", ^{
        ...
        itBehavesLike(@"AMPReference class equality", @{@"object" : reference, @"class" : [AMPCopyReference class]});
